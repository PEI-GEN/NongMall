package com.pei.mail.mailauthserver.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.pei.common.utils.HttpUtils;
import com.pei.common.utils.R;
import com.pei.common.vo.MemberResponseVo;
import com.pei.mail.mailauthserver.feign.MemberFeignService;
...
public class OAuth2Controller {
    ...
    public String weibo(@RequestParam("code") String code, HttpSession session) throws Exception {
        ...
        map.put("client_id","1629993894");
        map.put("client_secret","2892475f767c1e22761554e2757a30b9");
        map.put("grant_type","authorization_code");
        map.put("redirect_uri","http://auth.mymail.com/oauth2.0/weibo/success");
        map.put("code",code);
